data_mortality_multiple_2022 <- tribble(
  ...
  # Note: education_1989 (positions 61-62) was removed as of 2018; all states
  # now use the 2003 revision.
  ...
  "detail_age",                  70,   73,    4,  "int",  "Detail age (pos 70=age unit, 71-73=value)",            "1=Years (001-135)|2=Months (001-011)|4=Days (001-027)|5=Hours (001-023)|6=Minutes (001-059)|9=Age not stated (999)",
  "age_substitution_flag",       74,   74,    1,  "str",  "Age substitution flag",                                "1=Calculated age substituted for unknown reported age|blank=Not substituted",
  ...
  "current_data_year",          102,  105,    4,  "int",  "Current data year",                                    "2022=2022",
  ...
  # Note: for a subset of pregnancy records (O00-O99), the 5th position of the
  # 2nd condition may contain "1" to flag a maternal death classification.
  ...
  "record_condition_1",         344,  348,    5,  "str",  "Record-axis condition 1 (pos1-4=ICD code, pos5=blank or maternal flag)", "",
  ...
  # ── Race & Hispanic origin (positions 448-490) ────────────────────────────────
  # NOTE: Bridged-race variables (race_recode_3 at 449, race_recode_5 at 450,
  # bridged_race_flag at 447) were retired after data year 2020 and are no
  # longer present. Race Recode 6 (1997 OMB single-race standards) replaces
  # Race Recode 5 at position 450.
  ...
  "race_recode_6",              450,  450,    1,  "int",  "Race recode 6 (1997 OMB single-race standards; replaces Race Recode 5)", "1=White (only)|2=Black (only)|3=American Indian and Alaska Native (only)|4=Asian (only)|5=Native Hawaiian or Other Pacific Islander (only)|6=More than one race",
