...
data_mortality_multiple_2016 <- tribble(
  ...
  # ... [2016 Year Marker] ...
  "current_data_year", 102, 105, 4, "int", "Current data year", "2016",
  ...
  # [Note: Conditions 2-20 and record-axis 1-20 are identical to 2010-2015]
...
usethis::use_data(data_mortality_multiple_2016, overwrite = TRUE)
