...
# - The file layout is also separate for US and territories data from 2007 onward

data_mortality_multiple_2007 <- tribble(
  ~name,                        ~start, ~end, ~size, ~type, ~description,                                                        ~codes,
  "reserved_1",                 1,      19,   19,    "str", "Reserved positions (blank; note: expanded from 18 to 19 vs pre-2007)", "",
  ...
  "reserved_2",                 21,     60,   40,    "str", "Reserved positions (blank; geographic identifiers removed from 2007 onward per NCHS data access policy)", "",
  ...
  "current_data_year",          102,    105,  4,     "int", "Current data year",                                                  "2007=2007",
...
usethis::use_data(data_mortality_multiple_2007, overwrite = TRUE)
