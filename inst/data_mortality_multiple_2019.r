data_mortality_multiple_2019 <- tribble(
  ...
  "current_data_year",          102,  105,    4,  "int",  "Current data year",                                    "2019=2019",
  ...
  # ── Bridged Race (positions 445-450) ─────────────────────────────────────────
  "race",                       445,  446,    2,  "int",  "Bridged race (reported single or bridged multiple race)", "01=White|02=Black|03=American Indian (includes Aleuts and Eskimos)|04=Chinese|05=Japanese|06=Hawaiian (includes Part-Hawaiian)|07=Filipino|18=Asian Indian|28=Korean|38=Samoan|48=Vietnamese|58=Guamanian|68=Other Asian or Pacific Islander (areas reporting 18-58)|78=Combined other Asian or Pacific Islander",
  ...
  "race_recode_3",              449,  449,    1,  "int",  "Bridged race recode 3",                                "1=White|2=Races other than White or Black|3=Black",
  "race_recode_5",              450,  450,    1,  "int",  "Bridged race recode 5",                                "0=Other (Puerto Rico only)|1=White|2=Black|3=American Indian|4=Asian or Pacific Islander",
  ...
  "hispanic_origin_race_recode", 488,  488,    1,  "int",  "Hispanic origin/bridged race recode",                  "1=Mexican|2=Puerto Rican|3=Cuban|4=Central or South American|5=Other or unknown Hispanic|6=Non-Hispanic white|7=Non-Hispanic black|8=Non-Hispanic other races|9=Hispanic origin unknown",
...
usethis::use_data(data_mortality_multiple_2019, overwrite = TRUE)
