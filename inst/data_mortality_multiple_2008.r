# NOTE: 2008 marks a major structural change from 2003/2004.
# A new vital statistics data access policy excluding geographic identifiers
# goes into effect with the 2008 data year.
# - record_type (pos 19) is dropped
# - All geographic fields (positions 21-60) are removed and replaced with reserved positions
# - The file layout is also separate for US and territories data from 2008 onward

data_mortality_multiple_2008 <- tribble(
  ~name,                        ~start, ~end, ~size, ~type, ~description,                                                        ~codes,
  "reserved_1",                 1,      19,   19,    "str", "Reserved positions (blank; note: expanded from 18 to 19 vs pre-2008)", "",
  ...
  "reserved_2",                 21,     60,   40,    "str", "Reserved positions (blank; geographic identifiers removed from 2008 onward per NCHS data access policy)", "",
  ...
  "current_data_year",          102,    105,  4,     "int", "Current data year",                                                  "2008=2008",
...
usethis::use_data(data_mortality_multiple_2008, overwrite = TRUE)
