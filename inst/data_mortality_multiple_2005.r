# NOTE: 2005 marks a major structural change from 2003/2004.
# A new vital statistics data access policy excluding geographic identifiers
# goes into effect with the 2005 data year.
# - record_type (pos 19) is dropped
# - All geographic fields (positions 21-60) are removed and replaced with reserved positions
# - The file layout is also separate for US and territories data from 2005 onward

data_mortality_multiple_2005 <- tribble(
  ~name,                        ~start, ~end, ~size, ~type, ~description,                                                        ~codes,
  "reserved_1",                 1,      19,   19,    "str", "Reserved positions (blank; note: expanded from 18 to 19 vs pre-2005)", "",
  ...
  "reserved_2",                 21,     60,   40,    "str", "Reserved positions (blank; geographic identifiers removed from 2005 onward per NCHS data access policy)", "",
  ...
  "detail_age",                 70,     73,   4,     "str", "Detail age (pos 70=age unit, pos 71-73=value)",                      "1=Years (001-135,999)|2=Months (001-011,999)|4=Days (001-027,999)|5=Hours (001-023,999)|6=Minutes (001-059,999)|9=Age not stated (999)",
  "age_substitution_flag",      74,     74,   1,     "str", "Age substitution flag",                                              "1=Calculated age substituted for reported age|blank=Calculated age is not substituted",
  ...
  "age_recode_27",              77,     78,   2,     "int", "Age recode 27",                                                      "01=Under 1 month|02=1 month-11 months|03=1 year|04=2 years|05=3 years|06=4 years|07=5-9 years|08=10-14 years|09=15-19 years|10=20-24 years|11=25-29 years|12=30-34 years|13=35-39 years|14=40-44 years|15=45-49 years|16=50-54 years|17=55-59 years|18=60-64 years|19=65-69 years|20=70-74 years|21=75-79 years|22=80-84 years|23=85-89 years|24=90-94 years|25=95-99 years|26=100 years and over|27=Age not stated",
  "age_recode_12",              79,     80,   2,     "int", "Age recode 12",                                                      "01=Under 1 year|02=1-4 years|03=5-14 years|04=15-24 years|05=25-34 years|06=35-44 years|07=45-54 years|08=55-64 years|09=65-74 years|10=75-84 years|11=85 years and over|12=Age not stated",
  "infant_age_recode_22",       81,     82,   2,     "str", "Infant age recode 22 (blank if age 1 year and over or not stated)",  "blank=Age 1 year and over or not stated|01=Under 1 hour|02=1-23 hours|03=1 day|04=2 days|05=3 days|06=4 days|07=5 days|08=6 days|09=7-13 days|10=14-20 days|11=21-27 days|12=1 month|13=2 months|14=3 months|15=4 months|16=5 months|17=6 months|18=7 months|19=8 months|20=9 months|21=10 months|22=11 months",
  "place_of_death",             83,     83,   1,     "int", "Place of death and decedent's status",                               "1=Hospital clinic or Medical Center - Inpatient|2=Hospital Clinic or Medical Center - Outpatient or admitted to Emergency Room|3=Hospital Clinic or Medical Center - Dead on Arrival|4=Decedent's home|5=Hospice facility|6=Nursing home/long term care|7=Other|9=Place of death unknown",
  ...
  "current_data_year",          102,    105,  4,     "int", "Current data year",                                                  "2005=2005",
  ...
  "activity_code",              144,    144,  1,     "str", "Activity code",                                                      "0=While engaged in sports activity|1=While engaged in leisure activity|2=While working for income|3=While engaged in other types of work|4=While resting sleeping eating (vital activities)|8=While engaged in other specified activities|9=During unspecified activity|blank=Not applicable",
  "place_of_injury",            145,    145,  1,     "str", "Place of injury for causes W00-Y34 except Y06 and Y07",              "0=Home|1=Residential institution|2=School other institution and public administrative area|3=Sports and athletics area|4=Street and highway|5=Trade and service area|6=Industrial and construction area|7=Farm|8=Other Specified Places|9=Unspecified place|blank=Causes other than W00-Y34 except Y06 and Y07",
  "icd_code",                   146,    149,  4,     "str", "Underlying cause of death ICD-10 code (10th revision)",              "",
  "cause_recode_358",           150,    152,  3,     "int", "358 cause recode of underlying cause (range 001-456 not inclusive)",  "",
  "reserved_6",                 153,    153,  1,     "str", "Reserved position",                                                  "",
  "cause_recode_113",           154,    156,  3,     "int", "113 cause recode of underlying cause (range 001-135 not inclusive)",  "",
  "infant_cause_recode_130",    157,    159,  3,     "int", "130 infant cause recode (range 001-158 not inclusive; blank for non-infant records from 2002 onward)", "",
  "cause_recode_39",            160,    161,  2,     "int", "39 cause recode of underlying cause (range 01-42 not inclusive)",    "",
  ...
  "record_condition_1",         344,    348,  5,     "str", "Record-axis condition 1 (pos1-4=ICD code, pos5=blank)",              "",
  ...
  "race",                       445,    446,  2,     "str", "Race (reported single race or bridged race; US occurrence)",         "01=White|02=Black|03=American Indian (includes Aleuts and Eskimos)|04=Chinese|05=Japanese|06=Hawaiian (includes Part-Hawaiian)|07=Filipino|18=Asian Indian|28=Korean|38=Samoan|48=Vietnamese|58=Guamanian|68=Other Asian or Pacific Islander in areas reporting codes 18-58|78=Combined other Asian or Pacific Islander includes codes 18-68",
  "bridged_race_flag",          447,    447,  1,     "str", "Bridged race flag",                                                  "blank=Race is not bridged|1=Race is bridged",
  ...
  "hispanic_origin",            484,    486,  3,     "int", "Hispanic origin",                                                    "100-199=Non-Hispanic|200-209=Spaniard|210-220=Mexican|221-230=Central American|231-249=South American|250-259=Latin American|260-269=Puerto Rican|270-274=Cuban|275-279=Dominican|280-299=Other Hispanic|996-999=Unknown",
...
usethis::use_data(data_mortality_multiple_2005, overwrite = TRUE)
