...
data_mortality_multiple_2014 <- tribble(
  ...
  # ... [2014 Year Marker] ...
  "current_data_year", 102, 105, 4, "int", "Current data year", "2014",
  ...
  # [Note: Rows for conditions 2-20 and record conditions 1-20 are same as 2011/2012/2013]
...
usethis::use_data(data_mortality_multiple_2014, overwrite = TRUE)
