data_mortality_multiple_2018 <- tribble(
  ...
  "current_data_year",          102,  105,    4,  "int",  "Current data year",                                    "2018=2018",
...
usethis::use_data(data_mortality_multiple_2018, overwrite = TRUE)
